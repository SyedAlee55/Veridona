                    ...
                    <Grid container maxWidth="lg">
                            ...
                            <Grid item size={{ xs: 12, sm: 6 }}>
                                ...
                                >
                                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                                        <Box component="img" src="/Veridona.png" alt="Veridona Logo" sx={{ width: 40, height: 40, mr: 2 }} />
                        ...
                        <Grid container spacing={3} sx={{ mt: 4 }}>
                            <Grid item size={{ xs: 12, sm: 6, md: 4 }}>
                                ...
                                >
                                    <VisibilityIcon sx={{ fontSize: 40, color: '#151c3b', mb: 1 }} />
                            ...
                            <Grid item size={{ xs: 12, sm: 6, md: 4 }}>
                                ...
                                >
                                    <RocketLaunchIcon sx={{ fontSize: 40, color: '#00d4ff', mb: 1 }} />
                                    <Typography variant="h6" sx={{ fontWeight: 'bold', mb: 1 }}>
                                        Direct Impact
                                    </Typography>
                                    <Typography variant="body2" color="textSecondary">
                            ...
                            <Grid item size={{ xs: 12, sm: 6, md: 4 }}>
                                ...
                                >
                                    <ShieldIcon sx={{ fontSize: 40, color: '#151c3b', mb: 1 }} />
                                    <Typography variant="h6" sx={{ fontWeight: 'bold', mb: 1 }}>
                                        Secure & Trusted
                                    </Typography>
                                    <Typography variant="body2" color="textSecondary">
